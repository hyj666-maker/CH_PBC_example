...
void IB_CH_KEF_CZS_2014_test() {
    printf("IB_CH_KEF_CZS_2014_test begin\n");
    ...
    IB_CH_KEF_CZS_2014 *test = new IB_CH_KEF_CZS_2014(&G1, &G2, &Zp, &GT);
...
int main(int argc, char *argv[]) { // curve, scheme, turns, T;
    ...
    out = fopen("tmp_IB_CH_KEF_CZS_2014.txt", "w");
    fflush(out);
