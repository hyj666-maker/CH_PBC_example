...
void CH_ET::H(element_t *gs, element_t *m, element_t *res) {
    Hgsm_1(*gs,*m,*res);  
}

// void CH_ET::H_G1(element_t *m, element_t *res) {
//     Hm(*m, *res, this->tmp_Zn, *this->G1);
// }

CH_ET::CH_ET(element_t *_G1, element_t *_G2, element_t *_Zn, element_t *_GT) {
    this->G1 = _G1;
    this->G2 = _G2;
    this->Zn = _Zn;
    this->GT = _GT;
...
void CH_ET::KG(element_t *x, element_t *y) {
    element_pow_zn(*y, this->g, *x);
}


void CH_ET::Hash(element_t *L, element_t *m, element_t *r_1, element_t *r_2, element_t *a, element_t *y, element_t *h) {
...
void CH_ET::Forge(element_t *h, element_t *x, element_t *L, element_t *m, element_t *m_p, element_t *r_1, element_t *r_2, element_t *r_1_p, element_t *r_2_p) {
    // y
...
bool CH_ET::Verify(element_t *h, element_t *L,element_t *m_p, element_t *r_1_p, element_t *x) {
    // g^a' r_1_p
    // h^m'
    // y
    element_pow_zn(this->tmp_G1, this->g, *x);
